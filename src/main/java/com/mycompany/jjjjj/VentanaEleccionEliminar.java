 ...
 */
public class VentanaEleccionEliminar extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaEleccionEliminar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar eleccion");

        jLabel2.setText("Ingrese nro de eleccion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEleccionEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEleccionEliminar().setVisible(true);
            }
        });
    }
